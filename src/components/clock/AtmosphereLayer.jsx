...
export default function AtmosphereLayer({ mood, hour }) {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        className="absolute inset-0"
        style={{
          background: `radial-gradient(60% 50% at 50% 45%, ${moodCfg.halo} 0%, transparent 70%), radial-gradient(40% 40% at 30% 70%, ${ambient} 0%, transparent 70%)`,
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 120% at 50% 50%, transparent 40%, rgba(15,17,26,0.85) 100%)",
        }}
      />
    </div>
  );
